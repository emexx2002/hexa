          ...
          <div className={classes.container} style={{display:"flex"}}>
              ...
              <div className={classes.container}>
                 <h2 style={{fontWeight:"bold",}}>Tokenomics</h2>
                     ...
                     <p>
                         - Airdrop 13% (103,000,000ORB)<br/>
                         - Consultation 1.7% (17,000,000ORB)<br/>
                         - Presale 30% (300,000,000ORB)<br/>
                         - Blue Orb Ecosystem development 10% (100,000,000ORB)<br/>
                         - CEX listing 20% (200,000,000ORB)<br/>
                         - Marketing Wallet 3% (30,000,000ORB)<br/>
                         - DEX liquidity pool 25% (250,000,000ORB)
                     </p>
